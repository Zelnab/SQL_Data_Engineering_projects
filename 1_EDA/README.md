...
2. [`02_top_paying_skill.sql`](./02_top_paying_skill.sql) – salary analysis with aggregations
...
- **Top Paying Skills** – Analyzes the 10 highest-paying skills with salary and demand metrics
- **Optimal Skills** – Calculates an optimal score using natural log of demand combined with median salary to identify the most valuable skills to learn Key Insights
